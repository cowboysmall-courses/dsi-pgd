...
plt.plot(fpr_train, tpr_train, color = "darkorange", lw = 2, label = f"ROC Curve (AUC = {roc_auc_train:0.2f})")
...
plt.plot(fpr_test, tpr_test, color = "darkorange", lw = 2, label = f"ROC Xurve (AUC = {roc_auc_test:0.2f})")
plt.plot([0, 1], [0, 1], color = "navy", lw = 2, linestyle = "--")
