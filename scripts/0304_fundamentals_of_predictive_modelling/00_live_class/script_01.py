...
data = pd.read_csv("./data/0304_fundamentals_of_predictive_modelling/00_live_class/Performance Index.csv")
data.head()
...
pred = pd.read_csv("./data/0304_fundamentals_of_predictive_modelling/00_live_class/Performance Index new.csv")
