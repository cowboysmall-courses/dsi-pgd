...
salary_data <- read.csv.sql("./data/0104_exploratory_data_analysis/03_data_management/sal_data.csv", sql = "select * from file", header = TRUE)
bonus_data <- read.csv.sql("./data/0104_exploratory_data_analysis/03_data_management/bonus_data.csv", sql = "select * from file", header = TRUE)
