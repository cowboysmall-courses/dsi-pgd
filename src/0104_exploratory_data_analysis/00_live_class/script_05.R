...
# 1
demo_data <- read.csv("./data/0104_exploratory_data_analysis/00_live_class/TelecomData_CustDemo.csv", header = TRUE)
weekly_data <- read.csv("./data/0104_exploratory_data_analysis/00_live_class/TelecomData_WeeklyData.csv", header = TRUE)
