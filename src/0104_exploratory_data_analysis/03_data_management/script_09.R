...
salary_data <- read.csv.sql("./data/0104_exploratory_data_analysis/data_management/sal_data.csv", sql = "select * from file", header = TRUE)
bonus_data <- read.csv.sql("./data/0104_exploratory_data_analysis/data_management/bonus_data.csv", sql = "select * from file", header = TRUE)
