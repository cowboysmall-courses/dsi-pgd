...
salary_data <- read.csv("./data/0104_exploratory_data_analysis/03_data_management/sal_data.csv", header = TRUE)
head(salary_data)

bonus_data <- read.csv("./data/0104_exploratory_data_analysis/03_data_management/bonus_data.csv", header = TRUE)
head(bonus_data)
...
salary_01 <- read.csv("./data/0104_exploratory_data_analysis/03_data_management/basic_salary - 1.csv", header = TRUE)
salary_02 <- read.csv("./data/0104_exploratory_data_analysis/03_data_management/basic_salary - 2.csv", header = TRUE)
