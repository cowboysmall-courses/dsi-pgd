...
salary_data <- fread("./data/0104_exploratory_data_analysis/03_data_management/sal_data.csv")
bonus_data <- fread("./data/0104_exploratory_data_analysis/03_data_management/bonus_data.csv")
