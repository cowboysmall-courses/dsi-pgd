...
job_data = pd.read_csv("./data/0104_exploratory_data_analysis/04_descriptive_statistics/Job_Proficiency.csv")
...
retail_data = pd.read_csv("./data/0104_exploratory_data_analysis/04_descriptive_statistics/Retail_Data.csv")
