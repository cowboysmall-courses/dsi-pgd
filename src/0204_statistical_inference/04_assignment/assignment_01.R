...
pain_vas <- read.csv("./data/0204_statistical_inference/04_assignment/VAS\ DATA.csv", header = TRUE)
...
# 4 (Alternative) 
# the above approach is preferred because it provides an 
# easier structure for the boxplot
