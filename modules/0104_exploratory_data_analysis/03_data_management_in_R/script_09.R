...
salary_data <- read.csv.sql("../../../data/eda/data_management/sal_data.csv", sql = "select * from file", header = TRUE)
bonus_data <- read.csv.sql("../../../data/eda/data_management/bonus_data.csv", sql = "select * from file", header = TRUE)
