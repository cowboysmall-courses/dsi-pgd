...
salary_data <- fread("../../../data/0104_exploratory_data_analysis/data_management/sal_data.csv")
bonus_data <- fread("../../../data/0104_exploratory_data_analysis/data_management/bonus_data.csv")
