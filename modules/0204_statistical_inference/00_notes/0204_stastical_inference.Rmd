...
data <- read.csv("../../../data/si/analysis_of_variance/F\ test\ for\ 2\ variances.csv", header = TRUE)
...
data <- read.csv("../../../data/si/analysis_of_variance/Three\ Way\ Anova.csv", header = TRUE)
